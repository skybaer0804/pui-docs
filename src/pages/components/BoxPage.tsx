        ...
        <ComponentPage title="Box" description="Box 컴포넌트는 레이아웃과 스타일링을 위한 기본 컨테이너입니다.">
            <Stack spacing="md">
                ...
                <Card>
                    ...
                    <CardBody>
                        <Stack spacing="sm">
                            <Box padding="xs" sx={{ backgroundColor: 'var(--color-surface-subtle, #f5f5f5)', borderRadius: 'var(--primitive-radius-md, 8px)' }}>
                            ...
                            <Box padding="lg" sx={{ backgroundColor: 'var(--color-surface-subtle, #f5f5f5)', borderRadius: 'var(--primitive-radius-md, 8px)' }}>
                ...
                <Card>
                    ...
                    <CardBody>
                        <Stack spacing="sm">
                            <Box margin="xs" padding="sm" sx={{ backgroundColor: 'var(--color-surface-subtle, #f5f5f5)', borderRadius: 'var(--primitive-radius-md, 8px)' }}>
                                <Typography variant="body-medium">margin="xs"</Typography>
                            </Box>
                            <Box margin="sm" padding="sm" sx={{ backgroundColor: 'var(--color-surface-subtle, #f5f5f5)', borderRadius: 'var(--primitive-radius-md, 8px)' }}>
                                <Typography variant="body-medium">margin="sm"</Typography>
                            </Box>
                            <Box margin="md" padding="sm" sx={{ backgroundColor: 'var(--color-surface-subtle, #f5f5f5)', borderRadius: 'var(--primitive-radius-md, 8px)' }}>
                                <Typography variant="body-medium">margin="md"</Typography>
                            </Box>
                            <Box margin="lg" padding="sm" sx={{ backgroundColor: 'var(--color-surface-subtle, #f5f5f5)', borderRadius: 'var(--primitive-radius-md, 8px)' }}>
                ...
                <Card>
                    ...
                    <CardBody>
                        <Stack spacing="sm">
                            <Typography variant="body-medium">
                                sx prop을 사용하여 커스텀 스타일을 적용할 수 있습니다.
                            </Typography>
                            <Box
                                padding="md"
                                sx={{
